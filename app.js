...
projeto2 = {
    titulo: 'Conversor' ,
    descricao: 'Projeto desenvolvido utilizando javascript, html e css de um conversor de dólar em real.' ,
    foto: 'conversor.jpg'
}

projeto3 = {
    titulo: 'Mentalista' ,
    descricao: 'Projeto desenvolvido utilizando javascript, html e css de um jogo de adivinhação.' ,
    foto: 'mentalista.jpg'
}

projeto4 = {
    titulo: 'Alanaflix' ,
    descricao: 'Projeto desenvolvido utilizando javascript, html e css de uma plataforma de filmes.' ,
    foto: 'alanaflix.png'
}
